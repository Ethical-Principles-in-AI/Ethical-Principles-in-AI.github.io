            ...
            <div class="container text-center">
              <div class="row">
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/xiyue-jasmine-zhang/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
                ...
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/emily-traynor-64ab391a3/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/sarina-yang-xi/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
                ...
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/dhruv-sirohi/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/anya-pedersen-46b650224/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
                ...
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/jongjin-jung-445595204/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
              ...
              <div class="row">
                <div class="col-6">
                  <img alt="" class="rounded" style={{'width': '100%'}} src={chase}/>
                  <p></p>
                  <p style={{'text-align': 'center', 'font-weight': 'bold', 'font-size': '16pt'}}>Web Developer</p>
                  <p style={{'text-align': 'center', 'color': '#00a5b9', 'font-weight': 'bold'}}>Chase McDougall</p>
                  <a target="_blank" rel="noopener noreferrer" href="https://chasemcdo.github.io/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">Personal Site</button></div></a>
          ...
          <div class="container text-center">
              <div class="row">
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://gxwei.ca/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">Personal Site</button></div></a>
                ...
                <div class="col">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/chris-mountain/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
              ...
              <div class="row">
                ...
                <img alt="" class="rounded" style={{'width': '100%'}} src={fizzah}/>
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/fizzah-mansoor-6570971b0/"><div class="text-center"><button style={{width:"75%"}} type="button" class="btn btn-info">LinkedIn</button></div></a>
